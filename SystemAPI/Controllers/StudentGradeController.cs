...
namespace SystemAPI.Controllers
{
    ...
    public class StudentGradeController : ControllerBase
    {
        ...
        //[HttpGet("GetStudentGradesInSession/{sessionId}")]
        //public IActionResult GetStudentGradesInSession(int sessionId)
        //{
        //    try
        //    {
        //        var result = _repository.GetStudentGradesInSession(sessionId);
        //        return Ok(result);
        //    }
        //    catch (Exception e)
        //    {
