    ...
    public partial class prn231Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Request>(entity =>
            {
                ...
                entity.Property(e => e.NewGradeValue).HasColumnName("newGradeValue");
                ...
                entity.Property(e => e.ResponeContent)
                    .HasMaxLength(255)
                    .HasColumnName("responeContent");
                ...
                entity.HasOne(d => d.Grade)
                    ...
                    .HasConstraintName("FK__Request__gradeId__619B8048");

                entity.HasOne(d => d.RequestStatus)
                    .WithMany(p => p.Requests)
                    .HasForeignKey(d => d.RequestStatusId)
                    .HasConstraintName("FK__Request__request__628FA481");

                entity.HasOne(d => d.Student)
                    .WithMany(p => p.Requests)
                    .HasForeignKey(d => d.StudentId)
                    .HasConstraintName("FK__Request__request__60A75C0F");
            });
